...
public class T04_ex01 {
	...
	public static void main(String[] args) {
		 ...
		 /* System.out.println("문자입력 : "); char a = sc.next().charAt(0); // charAt 을 쓰려면
		 * nextLine이 아니라 next를 써야한다 //String a = sc.next().charAt(0); int aUni = a; //
		 * char 를 int로 강제형변환 System.out.println(a + "의 유니코드 : "+aUni);
		 * 
		 * 
		 * 
		 * // 2.국어, 영어, 수학 점수를 입력받아 총점 출력 // 평균출력(소수점 2째자리까지 출력)
		 * 
		 * System.out.println("\n국어 영어 수학 점수를 순서대로 적으시오 (예_ 35 45 68)"); int kor =
		 * sc.nextInt(); int mth = sc.nextInt(); int eng = sc.nextInt(); int total = kor
		 * + mth + eng; double 평균 = (double) total / 3;
		 * 
		 * System.out.printf("총점 : "+ total + "평균 : %.2f\n", 평균);
		 */
...
//		 3.3 iNum1의 값이 10.0으로 출력되게 하기
		System.out.println("\n"+iNum1+"을 double로 변환 하면? : " + (double) iNum1);
