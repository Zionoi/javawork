...
public class T02_Stack {
	...
	public static void main(String[] args) {
		...
		System.out.println("스택의 크기 : "+ monStack.size()); //4
		
//			monstack이 비어있지 않으면 while 실행
		while(!monStack.isEmpty()) {
			Money money = monStack.pop();// pop 안에 객체를 꺼낸다
			System.out.println("꺼내온 금액 : " + money.getValue() + "원"); // 스택은 마지막에 들어온게 먼저 빠져나온다
		}
